...
//sudo code=function called Vehicle, gas in Vehicle 100, drive -25, add charger and mustang, drive charger and mustang(x2) 
...
// CODE HERE...
// Sudo Code= add a method to the string proto, first letter caps, rest lower case, 

String.prototype.grammarPolice = function(){
var newString = this.toLowerCase().split(' ');
var newerString ='';
for(let i = 0; i < newString.length; i++){
  // console.log(newString);
 return newerString[i] = newString[i].charAt(0).toUpperCase() + newString[i].substring();

} console.log(substring);
newString = newString.join('');
return newerString;
};
"Hello to yOU".grammarPolice();
...
//SUDO===== function valueType 2 prams, 

var valueType = (x,y)=>{
if(typeof x === typeof y && x === y){
  return "Exactly the same";
}
else if(typeof x == typeof y && x == y){
return "Same value, different types";
}
else {return "Different Value"};
